            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xl-6" id="displayMap">
                        <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-chart-bar mr-1"></i><?php echo $translations['by-map'][$current_language]; ?><i><b><span id="totalCases"></span><?php echo $translations['cases'][$current_language]; ?> / <span id="totalDeath"></span> <?php echo $translations['deaths'][$current_language]; ?></b></i></div>
                    ...
                    <div class="col-xl-6" id="displayCumulative">
                        <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-chart-area mr-1"></i><?php echo $translations['canada-cumulative'][$current_language]; ?></div>
        ...
        <footer class="py-4 bg-light mt-auto">
            <div class="container-fluid">
                <div class="d-flex align-items-center justify-content-between small">
                    <div class="text-muted"><?php echo $translations['copyright'][$current_language]; ?> // <a href="mailto:noah.little@usask.ca">noah.little@usask.ca</a></div>
